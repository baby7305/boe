...
public class BoeApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(BoeApp.class);

    private final Environment env;

    public BoeApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(BoeApp.class);
